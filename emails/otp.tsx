...
const logoUrl =
  'https://images.pexels.com/photos/14878587/pexels-photo-14878587.jpeg?auto=compress&cs=tinysrgb&w=800&lazy=load'
  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={paragraph}>Nếu bạn không chủ động thực hiện thành động này, xin hãy bỏ qua email?</Text>
      </Container>
      <Text style={footer}>From Ecommerce Platform NestJS.</Text>
    </Body>
  </Html>
)

// Đây là cái dùng để mà preview thôi sẽ không ảnh hưởng đến logic
